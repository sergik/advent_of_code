...
for locations in antena_locations.values():
   for i in range(len(locations)):
      for j in range(i +1 , len(locations)):
         ...
         antenoid1 = locations[i]
        
         while in_bound(data, antenoid1):
            res.add(antenoid1)
            antenoid1 = (antenoid1[0] + x_dif, antenoid1[1] + y_dif)

         antenoid2 = locations[j]
         while in_bound(data, antenoid2):
            res.add(antenoid2)
            antenoid2 = (antenoid2[0] - x_dif, antenoid2[1] - y_dif)
